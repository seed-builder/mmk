...
define(function(require, exports, module) {
    ...
    exports.index = function ($, tableId,childTableId) {
        var editor = new $.fn.dataTable.Editor({
            ajax: {
                create: {
                    type: 'POST',
                    url: '/customer/display-policy',
                    data: {_token: $('meta[name="_token"]').attr('content')},
                },
                edit: {
                    type: 'PUT',
                    url: '/customer/display-policy/_id_',
                    data: {_token: $('meta[name="_token"]').attr('content')},
                },
                remove: {
                    type: 'DELETE',
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/customer/display-policy/pagination',
            columns: [
                {'data': 'id'},
                {'data': 'fbill_no'},
                {'data': 'fexp_type'},
        ...
        var chlidTable = $("#" + childTableId).DataTable({
            ...
            rowId: "id",
            ajax:{
                url : '/customer/display-policy-store/pagination',
                data : function (data) {
