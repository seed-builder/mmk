    ...
    exports.index = function ($, tableId,itemTableId,customers,materials) {
        var editor = new $.fn.dataTable.Editor({
            ajax: {
                create: {
                    type: 'POST',
                    url: '/customer/stock-in',
                    data: {_token: $('meta[name="_token"]').attr('content')},
                },
                edit: {
                    type: 'PUT',
                    url: '/customer/stock-in/_id_',
                    data: {_token: $('meta[name="_token"]').attr('content')},
                },
                remove: {
                    type: 'DELETE',
        ...
        var table = $("#" + tableId).DataTable({
            ...
            paging: true,
            rowId: "id",
            ajax: '/customer/stock-in/pagination',
            columns: [
                {'data': 'id'},
                {'data': 'fbill_no'},
                {'data': 'fsend_date'},
        ...
        var itemEditor = new $.fn.dataTable.Editor({
            ajax: {
                create: {
                    type: 'POST',
                    url: '/customer/stock-in-item',
                    data: {_token: $('meta[name="_token"]').attr('content')},
                },
                edit: {
                    type: 'PUT',
                    url: '/customer/stock-in-item/_id_',
                    data: {_token: $('meta[name="_token"]').attr('content')},
                },
                remove: {
                    type: 'DELETE',
        ...
        $(".check").on('click',function () {
            dataCheck(table,'/customer/stock-in/check');
        })

        $(".uncheck").on('click',function () {
            dataCheck(table,'/customer/stock-in/uncheck');
        })
        table.on( 'select', rowSelect).on( 'deselect', rowSelect);
