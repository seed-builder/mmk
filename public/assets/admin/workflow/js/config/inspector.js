...
(function() {
    ...
    var options = {
        ...
        colorPalette: [
            { content: 'transparent', icon: '/assets/admin/workflow/assets/transparent-icon.png' },
            { content: '#f6f6f6' },
            { content: '#dcd7d7' },
            { content: '#8f8f8f' },
            { content: '#c6c7e2' },
        ...
        imageIcons: [
            { value: '/assets/admin/workflow/assets/image-icon1.svg', content: '<img height="42px" src="/assets/admin/workflow/assets/image-icon1.svg"/>' },
            { value: '/assets/admin/workflow/assets/image-icon2.svg', content: '<img height="80px" src="/assets/admin/workflow/assets/image-icon2.svg"/>' },
            { value: '/assets/admin/workflow/assets/image-icon3.svg', content: '<img height="80px" src="/assets/admin/workflow/assets/image-icon3.svg"/>' },
            { value: '/assets/admin/workflow/assets/image-icon4.svg', content: '<img height="80px" src="/assets/admin/workflow/assets/image-icon4.svg"/>' }
        ],

        imageGender: [
            { value: '/assets/admin/workflow/assets/member-male.png', content: '<img height="50px" src="/assets/admin/workflow/assets/member-male.png" style="margin: 5px 0 0 2px;"/>' },
            { value: '/assets/admin/workflow/assets/member-female.png', content: '<img height="50px" src="/assets/admin/workflow/assets/member-female.png" style="margin: 5px 0 0 2px;"/>' }
        ],
