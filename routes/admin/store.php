...
Route::post('store/forbidden', ['uses' => 'StoreController@forbidden']);
Route::post('store/start_use', ['uses' => 'StoreController@start_use']);
...
Route::post('store/update-number', ['uses' => 'StoreController@updateNumber']);
