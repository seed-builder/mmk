...
Route::group(['prefix' => 'sale-order-item', 'middleware' => 'api.sign'], function () {
    ...
    *      type="",
    *      @SWG\Parameters(
    *          @SWG\Parameter(name="box_qty", description="箱数量", required=false,type="integer", paramType="form", defaultValue="0.00" ),
    *          @SWG\Parameter(name="bottle_qty", description="瓶数量", required=false,type="integer", paramType="form", defaultValue="0.00" ),
    *          @SWG\Parameter(name="present_box_qty", description="赠送品箱数量", required=false,type="integer", paramType="form", defaultValue="0.00" ),
    *          @SWG\Parameter(name="present_bottle_qty", description="赠送品瓶数量", required=false,type="integer", paramType="form", defaultValue="0.00" ),
