...
Route::group(['prefix' => 'work-flow-task', 'middleware' => 'api.sign'], function () {
    ...
    */
	 ...
	 * )
	 */
	Route::post('/batch-agree', ['as' => 'WorkFlowTask.batchAgree', 'uses' => 'WorkFlowTaskController@batchAgree']);

	/**
	 * @SWG\Api(
	 *     path="/api/work-flow-task/batch-against",
	 *     @SWG\Operation(
	 *      method="POST",
	 ...
	 * )
	 */
	Route::post('/batch-against', ['as' => 'WorkFlowTask.batchAgainst', 'uses' => 'WorkFlowTaskController@batchAgainst']);
