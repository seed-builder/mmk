...
Route::group(['prefix' => 'visit-line', 'middleware' => 'api.sign'], function () {
     ...
     *          @SWG\Parameter(name="fdate", description="日期", required=false,type="string", paramType="form", defaultValue="" ),
                ...
                @SWG\Parameter(name="fstatus", description="线路巡访状态", required=true,type="string", paramType="form", defaultValue="" ),
     ...
     *      type="",
     *      @SWG\Parameters(
     *          @SWG\Parameter(name="fstatus", description="线路巡访状态（1-未开始，2-进行中，3-已完成）", required=true,type="string", paramType="form", defaultValue="" ),
