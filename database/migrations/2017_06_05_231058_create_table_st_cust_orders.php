...
class CreateTableStCustOrders extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        Schema::dropIfExists('st_cust_orders');
    }
}
