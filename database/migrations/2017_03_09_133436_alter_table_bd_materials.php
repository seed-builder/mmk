...
class AlterTableBdMaterials extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('bd_materials', function (Blueprint $table) {
            //
	        $table->increments('id');
	        ...
	        $table->integer('fratio')->default(0)->comment('换算成销售单位乘数');
    ...
    {
	    Schema::dropIfExists('bd_materials');
    }
}
