...
class CreateTableEngWorkCalendarTemplateData extends Migration
{
    ...
    {
        //
        Schema::create('eng_work_calendar_template_data', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('fentry_id')->comment('eng_work_calendar_template id');
    ...
    {
        //
        Schema::create('eng_work_calendar_template_data');
    }
}
