...
class CreateTableStStockOutItems extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('st_stock_out_items', function (Blueprint $table) {
            $table->increments('id');
	        $table->integer('fstock_out_id')->default(0)->comment('出库ID');
    ...
    {
        Schema::dropIfExists('st_stock_out_items');
    }
}
