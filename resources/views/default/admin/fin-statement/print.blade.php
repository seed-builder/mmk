...
$nextMonth = strtotime('+1 m', strtotime($firstday));
$lastday = strtotime('-1 d', $nextMonth);
?>
                                    ...
                                    <tr  class="sign">
                                        <td colspan="5" style="height: 180px;overflow: auto;width: 50%;font-size: 16px !important;">
                                            <div style="position: relative;">
                                                ...
                                                <div style="position: absolute ; top: 140px; right: 250px;font-size: 16px !important;"><span class="sign">经办人：</span></div>
                                            </div>
                                        </td>
