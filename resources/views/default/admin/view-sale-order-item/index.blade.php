                        ...
                        <div class="panel panel-default" >
                            <form class="form-horizontal filter "  filter-table="#moduleTable">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control filter-condition" filter-name="customer_name" filter-operator="like" >
                                    </div>
                                </div>
                                <div class="form-group">
...
@section('js')
    ...
    <script type="text/javascript">
        $(function () {
            seajs.use('admin/view_sale_order_item.js', function (app) {
